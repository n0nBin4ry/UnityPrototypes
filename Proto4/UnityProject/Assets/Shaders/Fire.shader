        ...
        BlendOp[_BlendOp]
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    float xd = tex2D(_Distort, i.uv * _DistortScale);
                    float zd = tex2D(_Distort, i.uv * _DistortScale);
                    ...
                    float xn = tex2D(_Noise, (i.uv * _Scale));
                    float zn = tex2D(_Noise, (i.uv * _Scale));
